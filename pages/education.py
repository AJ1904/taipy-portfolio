...
text = "Welcome to the education section!"
...
<div class="education-logo">
    ...
    <div class="education-text">
        ...
        <ul class="custom-list">
            <li><h6 class="educationh6">👩🏻‍🎓 Department of Computer Science Scholarship 2023-2024</h6></li>
            <li><h6 class="educationh6">👩🏻‍🎓 Grace Hopper Celebration 2023 Scholarship</h6></li>
            <li><h6 class="educationh6">👩🏻‍🎓 Artificial Intelligence, Deep Learning, Machine Learning</h6></li>
            <li><h6 class="educationh6">👩🏻‍🎓 Analysis of Algorithms, Software Engineering, Software Reverse Engineering</h6></li>
            <li><h6 class="educationh6">👩🏻‍🎓 Distributed Systems and Cloud Computing, Robotics and Spatial Intelligence, AI Robotics</h6></li>
            <li><h6 class="educationh6">👩🏻‍🎓 GPA 3.67/4.0 </h6></li>
...
<div class="education">
<div class="education-logo">
    <a href="https://www.manit.ac.in/" target="_blank"><img src="assets/manit_logo.png" alt="MANIT Logo"></img></a>
    </div>
    <div class="education-text">
...
# <div class="education">
# <div class="education-logo">
#     <img src="assets/sgsamnem_logo.png" alt="MANIT Logo"></img>
#     </div>
#     <div class="education-text">
#         <h3>Shri Gujarati Samaj A.M.N. English Medium School</h3>
#         <h4>Bachelor of Technology in Computer Science & Engineering</h4>
#         <h5>Aug 2015 - May 2019</h5>
#         <ul class="custom-list">
#             <li><h6 class="educationh6">👩🏻‍🎓 Artificial Intelligence, Deep Learning, Machine Learning</h6></li>
